...
import { createPresignedGetUrl, generateResultKey } from './s3';
...
interface EngineParams {
  ...
  signal?: AbortSignal;
  generationId?: string; // For S3 result storage
}
...
export async function callEngineAndUploadToS3(params: EngineParams): Promise<EngineResult> {
