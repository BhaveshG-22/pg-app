            ...
            {plans.map((plan, idx) => {
              ...
              return (
                <div key={idx} className="flex flex-col">
                  {/* Pricing Card */}
                  <div className={`bg-gray-900 rounded-2xl border ${plan.popular ? 'border-white ring-2 ring-white/20' : 'border-gray-700'} p-8 flex-1 relative`}>
                    {plan.popular && (
                    ...
                    <button
                      ...
                      {loadingPlan !== plan.name && <ArrowUpRight className="w-5 h-5" />}
                    </button>
